...
// const remove = (id) => {
//     Axios.post(`http://localhost:3001/updateStatus/${id}`).then((response) => {
//         setOrders(
//             orders.filter((val) => {
//                 return val.id != id
//             })
...
<div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarsFurni">
        ...
        <li >
						...
						<li class="nav-item active"><Link class="nav-link" to="/PendingOrders">Pending Orders</Link></li>
        ...
        <div class="row justify-content-between">
            <div class="col-lg-5">
                <div class="intro-excerpt">
                    <h1 data-testid ="page-title">Pending Orders</h1>
                </div>
            </div>
            <div class="col-lg-7">
...
<div class="col-12 col-md-4 col-lg-3 mb-5">
        ...
        <img src="images/product1.png" class="img-fluid product-thumbnail"/>
              ...
              <button type="button" class="btn btn-xs" data-mdb-toggle="modal"data-mdb-target="#exampleModal"  onClick={()=>{
